...
public class MercadoPagoController {
    ...
    @PostMapping()
    public String getList(@RequestBody Request request){
        if(request == null){return "Error recibiendo pedido";}

        String title = "Pedido nro "+request.getId();
        int quantity = 1;
        Double price = request.getTotal();
